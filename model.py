...
"""GPT model architecture — attention, transformer blocks, full model.
 
Fully parameterized by a config dict (see config.py), so the same classes
work for every GPT-2 size from 124M up to 1.5B.
"""
import torch
